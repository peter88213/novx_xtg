[![Download the latest release](docs/img/download-button.png)](https://raw.githubusercontent.com/peter88213/novx_xtg/main/dist/novx_xtg_v5.7.0.pyz)
...
Download the latest release [novx_xtg_v5.7.0.pyz](https://github.com/peter88213/novx_xtg/raw/main/dist/novx_xtg_v5.7.0.pyz)

- Launch *novx_xtg_v5.7.0.pyz* by double-clicking (Windows desktop),
- or execute `python novx_xtg_v5.7.0.pyz` (Windows), resp. `python3 novx_xtg_v5.7.0.pyz` (Linux) on the command line.
...
The package is also available in zip format: [novx_xtg_v5.7.0.zip](https://github.com/peter88213/novx_xtg/raw/main/dist/novx_xtg_v5.7.0.zip)

- Extract the *novx_xtg_v5.7.0* folder from the downloaded zipfile "novx_xtg_v5.7.0.zip".
