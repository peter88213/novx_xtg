[![Download the latest release](docs/img/download-button.png)](https://raw.githubusercontent.com/peter88213/novx_xtg/main/dist/novx_xtg_v5.0.1.pyzw)
...
Download the latest release [novx_xtg_v5.0.1.pyzw](https://github.com/peter88213/novx_xtg/raw/main/dist/novx_xtg_v5.0.1.pyzw)

- Launch *novx_xtg_v5.0.1.pyzw* by double-clicking (Windows/Linux desktop),
- or execute `python novx_xtg_v5.0.1.pyzw` (Windows), resp. `python3 novx_xtg_v5.0.1.pyzw` (Linux) on the command line.
...
The package is also available in zip format: [novx_xtg_v5.0.1.zip](https://github.com/peter88213/novx_xtg/raw/main/dist/novx_xtg_v5.0.1.zip)

- Extract the *novx_xtg_v5.0.1* folder from the downloaded zipfile "novx_xtg_v5.0.1.zip".
